...
| 헤더                        | 값                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Content-Security-Policy`   | `default-src 'self'; script-src 'self' 'nonce-…' https://accounts.google.com https://t1.kakaocdn.net; style-src 'self' 'unsafe-inline'; img-src 'self' data: https://*.cloudfront.net https://*.googleusercontent.com https://*.kakaocdn.net; font-src 'self'; connect-src 'self' https://accounts.google.com https://kauth.kakao.com; frame-src https://accounts.google.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'; object-src 'none'; upgrade-insecure-requests` — 도메인 목록은 구현 시 실제 SDK 요구에 맞춰 확정하고 여기 갱신한다 |
